...
fff(1).fileprep = [fileprep 'Div/Div_1Berg_SI_yesSI/ResultsFiles/Div_1Berg_SI_yesSI-'];
fff(2).fileprep = [fileprep 'Div/Div_1Berg_FV_yesSI/ResultsFiles/Div_1Berg_FV_yesSI-'];
fff(3).fileprep = [fileprep 'Div/Div_1Berg_EL_yesSI/ResultsFiles/Div_1Berg_EL_yesSI-'];
...
fff(2).TITLE = '';
%fff(3).TITLE = ['Time = ' num2str(round(time2plot/360)/10) ' hours'];
fff(3).TITLE = 'Divergent wind over iceberg in sea ice'; %['Time = ' num2str(time2plot) ' s'];
...
for b = 1:3
    ...
    if b == 3
        ...
        set(hleg,'Location','South','FontSize',7)
